...
class PluginJsonGenerator
{
    ...
    private function parseCliOptions()
    {
        $longopts = array(
            ...
            "zip:",             // Optional: Path to plugin zip file for sha256
            "help",             // Show help
        );
    ...
    private function generateMetadata()
    {
        ...
        // If --zip is provided, calculate sha256 and add to metadata
    ...
    echo "  --zip=FILE             Path to plugin zip file; will include sha256 hash in output\n";
